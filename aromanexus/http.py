...
from aromanexus.cache import default_http_cache_dir
from aromanexus.models import utc_now_iso

DEFAULT_CACHE_DIR = default_http_cache_dir()
DEFAULT_USER_AGENT = "AromaNexus/0.3 (+https://github.com/rastagan-git/AromaNexus; research client)"
